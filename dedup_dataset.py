"""
Loại bỏ ảnh trùng lặp (byte-for-byte) khỏi rice_data TRƯỚC khi chia tập.
...
print("Bước tiếp theo: xóa rice_split cũ, sửa SOURCE_DIR trong train_rice.py thành 'rice_data_clean', rồi train lại.")
