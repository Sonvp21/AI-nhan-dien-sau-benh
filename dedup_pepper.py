"""
Loại bỏ ảnh trùng lặp (byte-for-byte) khỏi pepper_data/merged TRƯỚC khi chia tập.
...
SOURCE_DIR = "pepper_data/merged"
CLEAN_DIR = "pepper_data_clean"
...
print("Bước tiếp theo: xóa rice_split cũ, sửa SOURCE_DIR trong train_rice.py thành 'pepper_data/merged_clean', rồi train lại.")
