{{-- ================= THANH TAB: Chuẩn đoán bệnh / Bản đồ dịch bệnh.
     Hiện LUÔN, kể cả chưa đăng nhập (không còn yêu cầu đăng nhập để lưu report
     lên bản đồ nên không cần gate theo @auth nữa, và cũng không còn tab
     "Lịch sử của tôi" vì report không gắn với tài khoản nữa).
     Dùng lại ở agri-index.blade.php (dưới banner, chỉ desktop - mobile dùng
     drawer riêng), agri-disease-map.blade.php. ================= --}}
@php
  $navTabs = [
