"""
Train model phân loại bệnh lá ngô - Corn or Maize Leaf Disease Dataset
4 lớp: Blight, Common_Rust, Gray_Leaf_Spot, Healthy
Lưu ý: Gray_Leaf_Spot ít ảnh hơn hẳn 3 lớp còn lại (574 vs ~1150-1300) -> theo dõi recall lớp này kỹ khi đọc kết quả
"""
...
SOURCE_DIR = "corn_data_clean"
SPLIT_DIR = "corn_split"
...
for epoch in range(EPOCHS):
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), "best_corn_model.pth")
        print(f"  -> Đã lưu model tốt nhất (Val Acc: {val_acc:.3f})")

print(f"\nHoàn tất training. Val Acc tốt nhất: {best_val_acc:.3f}")

model.load_state_dict(torch.load("best_corn_model.pth"))
model.eval()
