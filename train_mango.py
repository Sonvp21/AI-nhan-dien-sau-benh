"""
Train model phân loại bệnh lá xoài - Mango Leaf Disease Dataset (Arya Shah)
8 lớp: Anthracnose, Bacterial Canker, Cutting Weevil, Die Back, Gall Midge, Healthy, Powdery Mildew, Sooty Mould
Dataset cân bằng tuyệt đối (500 ảnh/lớp gốc), đã dedup: loại 21/4000 ảnh trùng (0.5%)
"""
...
SOURCE_DIR = "mango_data_clean"
SPLIT_DIR = "mango_split"
...
for epoch in range(EPOCHS):
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), "best_mango_model.pth")
        print(f"  -> Đã lưu model tốt nhất (Val Acc: {val_acc:.3f})")

print(f"\nHoàn tất training. Val Acc tốt nhất: {best_val_acc:.3f}")

model.load_state_dict(torch.load("best_mango_model.pth"))
model.eval()
