"""
Train model phân loại bệnh lá cà chua - Tomato Leaf Disease (kaustubhb999)
10 lớp: Bacterial_spot, Early_blight, Late_blight, Leaf_Mold, Septoria_leaf_spot,
Spider_mites, Target_Spot, Tomato_mosaic_virus, Tomato_Yellow_Leaf_Curl_Virus, healthy
Dataset đã dedup: loại 147/11000 ảnh trùng (1.3%)
"""
...
SOURCE_DIR = "tomato_data_clean"
SPLIT_DIR = "tomato_split"
...
model.load_state_dict(torch.load("best_tomato_model.pth"))
model.eval()
